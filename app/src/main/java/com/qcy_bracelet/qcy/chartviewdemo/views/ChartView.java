package com.qcy_bracelet.qcy.chartviewdemo.views;
...
import com.qcy_bracelet.qcy.chartviewdemo.bean.DayCondition;
...
public class ChartView extends SurfaceView {
     ...
     * chart图线的颜色
     */
    private int chartLineColor = getResources().getColor(R.color.back);
    /**
     * 数据点的颜色
     */
...
//					canvas.drawText(axesData.get(i).getTopText(), axesData.get(i).X, topPadding, paintTopText);
    ...
    private void drawYValueText(Canvas canvas) {
        ...
        canvas.drawText("1000", leftPadding + (yTextWidth + leftTextSize) / 2, height - bottomPadding - xTextHeight - (spaceYLength * 5) + leftTextSize / 2, paint);
        canvas.drawText("800", leftPadding + (yTextWidth + leftTextSize) / 2, height - bottomPadding - xTextHeight - (spaceYLength * 4) + leftTextSize / 2, paint);
        canvas.drawText("600", leftPadding + (yTextWidth + leftTextSize) / 2, height - bottomPadding - xTextHeight - (spaceYLength * 3) + leftTextSize / 2, paint);
        canvas.drawText("400", leftPadding + (yTextWidth + leftTextSize) / 2, height - bottomPadding - xTextHeight - (spaceYLength * 2) + leftTextSize / 2, paint);
        canvas.drawText("200", leftPadding + (yTextWidth + leftTextSize) / 2, height - bottomPadding - xTextHeight - (spaceYLength * 1) + leftTextSize / 2, paint);
    }
